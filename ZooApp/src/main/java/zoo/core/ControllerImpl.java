...
public class ControllerImpl implements Controller {
    ...
    public String addAnimal(String areaName, String animalType, String animalName, String kind, double price) {
        ...
        boolean areaAndAnimalAreLand = areaType.equals("LandArea") && animalType.equals("TerrestrialAnimal");
        boolean areaAndAnimalAreWater = areaType.equals("WaterArea") && animalType.equals("AquaticAnimal");

        if(areaAndAnimalAreWater || areaAndAnimalAreLand) {
